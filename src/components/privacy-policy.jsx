                ...
                <div className="privacy-main">
                    ...
                    <div>
                        ...
                        <div className="privacy-text">
                            <p data-i18n="privacyPolicy.first.subText">・個人情報保護法をはじめとした関係法令・規範を遵守いたします。</p>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="privacy-text">
                            ...
                            <ol>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.first">本サービスに関する各種事項の連絡や情報提供を行うため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.second">本サービスを提供するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.third">お客様のお申込みにかかる本サービス間の情報連携のため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.fourth">電子メール配信サービスのお申し込みの確認やメールを配信するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.fifth">本サービスに関するご購入の確認やお届けをするため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.sixth">本サービスに関するご請求、お支払いとその確認をするため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.seventh">ご協力いただいた調査等に対する謝礼等をお送りするため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.eighth">ご応募いただいた懸賞等に対する景品等をお送りするため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.ninth">本サービスの利用状況等を調査・分析するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.tenth">本サービスの内容をよりご満足いただけるよう改良・改善し、または新サービスの開発のため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.eleventh">本サービスの内容をお客様にあわせてカスタマイズするため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.twelfth">本サービスに関する満足度を調査するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.thirteenth">取得情報を統計的に処理した情報を、集約し調査結果として公表するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.fourteenth">本サービス、新サービスに関する研究開発をするため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.fifteenth">本サービス、新サービスその他の各種サービスのご案内やお知らせをお届けする等、マーケティングで利用するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.sixteenth">調査のご協力依頼や各種イベントへのご参加をお願いしたり、その結果等をご報告するため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.seventeenth">本サービス運営上のトラブルの解決のため</p></li>
                                <li><p data-i18n="privacyPolicy.fifth.subText.second.eighteenth">本サービスに関する不正利用防止や安全性の確保のため</p></li>
                            </ol>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="privacy-text">
                            ...
                            <ol>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.first">当社が利用目的の達成に必要な範囲内において個人情報の取扱いの全部または一部を委託する場合</p></li>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.second">合併その他の事由による事業の承継に伴って個人情報が提供される場合</p></li>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.third">提携先または情報収集モジュール提供者へ個人情報が提供される場合</p></li>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.fourth">国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって、ユーザーの同意を得ることによって当該事務の遂行に支障を及ぼすおそれがある場合</p></li>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.fifth">代理購入における商品発送業務において、発送元（ECサイト等）に対してお客様の個人情報を提供する場合（当社が提供するお客様の個人情報は、氏名（フリガナを含む）、住所、電話番号（携帯電話番号・ファクシミリ番号を含む）、メールアドレス、会社名・団体名、勤務先所在地、その他連絡先に関する情報、ニックネーム、生年月日、性別、ウォレットアドレスなどです。お客様の個人情報は書面、電話、FAXもしくは電子データ等で提供されます。）</p></li>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.sixth">ふるさと納税業務に必要な事務等を遂行するために必要な場合（当社は、JPYCふるさと納税利用規約に定めた情報を提供します。）</p></li>
                                <li><p data-i18n="privacyPolicy.eighth.subText.second.seventh">その他、個人情報の保護に関する法律（以下「個人情報保護法」といいます。）その他の法令で認められている場合</p></li>
                            </ol>
                        </div>
                    </div>
                    <div>
