        ...
        <>
            ...
            <main className="main">
                ...
                <section className={styles.tax}>
                    ...
                    <div className={styles.tax_people}>
                        <img src={ohta} className={styles.tax_people_img} alt="Hironori Ido"/>
                        <div className={styles.tax_center}>
                            <p className={styles.tax_name}>太田 陽平</p>
                            <p className={styles.tax_description}>大手監査法人で監査業務・M&amp;A関連業務に従事。その後官民ファンドのREVIC（地域経済活性化支援機構）にて中小企業の再生支援業務に従事する。現在は独立し、コンサルティング等を行うほか、ブロックチェーン系ベンチャーの顧問にも就任している。自身も暗号資産を保有しながら、リサーチを継続しており、個人投資家・暗号資産保有企業の目線に立った支援が可能。</p>
                        </div>
